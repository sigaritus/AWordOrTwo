...
public class GuideActivity extends Activity{
	 private ViewPager viewPager;
	    ...
	    public void onCreate(Bundle savedInstanceState) {
	        ...
	        pageViews.add(inflater.inflate(R.layout.start, null));
	        pageViews.add(inflater.inflate(R.layout.guide, null));
	        ...
	        for(int i=0;i<pageViews.size();i++){
	            ...
	            //设置小圆点imageview的参数
	            imageView.setLayoutParams(new LayoutParams(15,15));//创建一个宽高均为20 的布局
	            ...
	            if(i==0){
	                ...
	                imageViews[i].setBackgroundResource(R.drawable.indicator1);
	            }
	        ...
	        View view = View.inflate(this, R.layout.guide, null);
	        endImageView = (ImageView)view.findViewById(R.id.end);
	        endImageView.setOnClickListener(new endGuideListener());
	    }
	    
	    private class endGuideListener implements OnClickListener{
	    ...
	    class GuidePageChangeListener implements OnPageChangeListener{
	        ...
	        public void onPageSelected(int position) {
	            ...
	            for(int i=0;i<imageViews.length;i++){
	                imageViews[position].setBackgroundResource(R.drawable.indicator1);
